            ...
            <div class="card border-0 bg-transparent">
                <div class="card-body bg-transparent ">
                    <form method="POST" class="form-sign w-[410px]  text-white font-['Montserrat']   " action="{{ route('login') }}">
                        <div class="m-4">
                            <img id="contentImg" src="{{ asset('img/foguete.png') }}" class="w-[150px] mx-auto duration-[2.5s] scale-90 hover:scale-100" alt="Astronauta no foguete">
                            <img id="contentLogo" src="{{ asset('img/logo.png') }}" class="w-[350px]" alt="logo">
                        </div>
                        @csrf
